            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:636ef381e89adfcd0174e73411c5a8530abcebc3@sha256:00b379c65d53966416fc2e39e9b3c770a5808cfa4de2adc6c0e49f0bf99dd18d"
                    }
                }
            }
        }
